...
from Models.Autoencoder import build_lstm_autoencoder, make_tf_dataset
...
def test_lstm_autoencoder(sequence_length, dimension, batch_size, sequence_count):
    ...
    lstm_autoencoder: Model = build_lstm_autoencoder(sequence_length, dimension, 32)
    history = lstm_autoencoder.fit(dataset, epochs=1, steps_per_epoch=1)
