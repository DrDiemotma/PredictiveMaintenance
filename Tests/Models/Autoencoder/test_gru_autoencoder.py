...
from Models.Autoencoder import build_gru_autoencoder, make_tf_dataset
...
def test_gru_autoencoder(sequence_length, dimension, batch_size, sequence_count):
    ...
    gru_autoencoder: Model = build_gru_autoencoder(sequence_length, dimension, 32)
    history = gru_autoencoder.fit(dataset, epochs=1, steps_per_epoch=1)
